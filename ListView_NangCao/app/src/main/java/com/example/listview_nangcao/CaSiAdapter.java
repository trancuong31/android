...
public class CaSiAdapter extends BaseAdapter {
    ...
    public CaSiAdapter(List<CaSi> caSiList, Context context, int layout) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       if(convertView==null){
           ...
           viewHoder= (CaSiAdapter.viewHoder) convertView.getTag();
       }
        //gán giá trị
        ...
        //gán animation
        Animation animation= AnimationUtils.loadAnimation(context,R.anim.animation_custom);
